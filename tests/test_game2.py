...
import os
import json
from main_copy_2 import Room, Player, Creature, GameObject, save_game, load_game, create_game_world, serialize_rooms, serialize_creature
...
def test_pick_up_and_drop_items():
    ...
    assert "Torch" in player.current_room.inventory
